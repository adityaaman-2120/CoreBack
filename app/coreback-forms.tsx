          ...
          <>
            ...
            {s.credits.map((c) => (
              <div className="settings-item" key={c.id}>
                ...
                <b style={{ color: "var(--good)" }}>{money(c.amountCents)}</b>
              </div>
            ))}
            ...
            <>
              <div className="transcript" aria-live="polite">
                {transcript.map((t) => (
                  <div
                    key={t.id}
                    className={`utterance ${t.speaker !== "CoreBack" ? "user" : ""}`}
                  >
                    <b>{t.speaker}</b>
                    {t.text}
                  </div>
  ...
  return (
    ...
    >
      ...
      <div className="form-grid">
        ...
        <Field label="Repair job">
          <input name="job" required maxLength={80} placeholder="JOB-100" />
        </Field>
        <Field label="Part number">
        ...
        <Field label="Part description" full>
          <input
            ...
            minLength={3}
            maxLength={160}
            placeholder="Remanufactured alternator"
          />
        </Field>
